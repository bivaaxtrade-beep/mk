...
export const StockLogoImage = ({ icon, name, size }: { icon: { color: string; label: string; logoUrl: string; logoUrl2?: string }, name: string, size: number }) => {
  const [imgStage, setImgStage] = useState<number>(0);
  const urls = [icon.logoUrl, icon.logoUrl2].filter(Boolean) as string[];

  if (imgStage >= urls.length) {
    return (
      <div 
        className="rounded-lg flex items-center justify-center overflow-hidden shadow-lg border border-white/10 transition-all shrink-0"
        style={{ backgroundColor: icon.color || '#2A2C31', width: size, height: size }}
      >
  ...
  return (
    <div 
      className="rounded-lg flex items-center justify-center overflow-hidden bg-[#1e2026] shadow-lg border border-white/10 transition-all shrink-0 p-1"
...
export const AssetLogo = ({ name, size = 32 }: { name: string, size?: number }) => {
  ...
  const stockIcons: Record<string, { color: string; label: string; logoUrl: string; logoUrl2?: string }> = {
    'Apple': { color: '#000000', label: '', logoUrl: 'https://img.icons8.com/color/96/apple-logo.png', logoUrl2: 'https://logo.clearbit.com/apple.com' },
    'Tesla': { color: '#E31937', label: 'T', logoUrl: 'https://img.icons8.com/color/96/tesla-logo.png', logoUrl2: 'https://logo.clearbit.com/tesla.com' },
    'Microsoft': { color: '#00A4EF', label: 'MS', logoUrl: 'https://img.icons8.com/color/96/microsoft.png', logoUrl2: 'https://logo.clearbit.com/microsoft.com' },
    'Google': { color: '#4285F4', label: 'G', logoUrl: 'https://img.icons8.com/color/96/google-logo.png', logoUrl2: 'https://logo.clearbit.com/google.com' },
    'Alphabet': { color: '#4285F4', label: 'G', logoUrl: 'https://img.icons8.com/color/96/google-logo.png', logoUrl2: 'https://logo.clearbit.com/google.com' },
    'Amazon': { color: '#FF9900', label: 'A', logoUrl: 'https://img.icons8.com/color/96/amazon.png', logoUrl2: 'https://logo.clearbit.com/amazon.com' },
    'Meta': { color: '#0668E1', label: 'M', logoUrl: 'https://img.icons8.com/color/96/meta.png', logoUrl2: 'https://logo.clearbit.com/meta.com' },
    'NVIDIA': { color: '#76B900', label: 'N', logoUrl: 'https://img.icons8.com/color/96/nvidia.png', logoUrl2: 'https://logo.clearbit.com/nvidia.com' },
    'Netflix': { color: '#E50914', label: 'N', logoUrl: 'https://img.icons8.com/color/96/netflix.png', logoUrl2: 'https://logo.clearbit.com/netflix.com' },
    'Intel': { color: '#0071C5', label: 'I', logoUrl: 'https://img.icons8.com/color/96/intel.png', logoUrl2: 'https://logo.clearbit.com/intel.com' },
    'Disney': { color: '#113CCF', label: 'D', logoUrl: 'https://img.icons8.com/color/96/disney.png', logoUrl2: 'https://logo.clearbit.com/disney.com' },
    'Yum Brands': { color: '#C41230', label: 'Y', logoUrl: 'https://logo.clearbit.com/yum.com', logoUrl2: 'https://img.icons8.com/color/96/kfc.png' },
    'Boeing': { color: '#0039A6', label: 'B', logoUrl: 'https://logo.clearbit.com/boeing.com', logoUrl2: 'https://img.icons8.com/color/96/boeing.png' },
  };
  ...
  if (stockKey) {
    ...
    return <StockLogoImage icon={icon} name={name} size={size} />;
  }
