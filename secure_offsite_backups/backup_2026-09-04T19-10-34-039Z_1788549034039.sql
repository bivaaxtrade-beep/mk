...
-- Generated at: 2026-09-04T19:10:34.039Z
...
INSERT OR IGNORE INTO "users" ("id", "uid", "email", "display_name", "nickname", "photo_url", "password_hash", "real_balance", "demo_balance", "currency", "tfa_enabled", "tfa_mode", "tfa_secret", "is_verified", "is_email_verified", "is_nid_verified", "nid_number", "is_admin", "phone", "country", "country_code", "first_name", "last_name", "gender", "dob", "birth_day", "birth_month", "birth_year", "time_zone", "language", "newsletter", "allow_notifications", "status", "kyc_status", "referred_by_uid", "referral_code", "referral_sub_id", "referral_type", "affiliate_balance", "total_affiliate_earnings", "referral_count", "custom_affiliate_share", "withdrawal_otp", "withdrawal_otp_expires_at", "total_live_volume", "updated_at", "created_at", "total_deposits", "smart_mode_enabled", "smart_mode_strategy", "manipulation_mode", "password", "bx_coins") VALUES (1, 'admin_seed_jkr99ew2', 'hamproosapport@gmail.com', 'Bivaax Super Admin', 'Admin', NULL, '$2b$10$U6D1vZ5t6vmrNteFB.zU5uw8RD9uOxLRBc8QF73yE6VfFVOQGjG2u', 1000, 10000, 'USD', 0, 'app', NULL, 0, 0, 0, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 'Standard', 'unverified', NULL, '7KBKZR', NULL, NULL, 0, 0, 0, NULL, NULL, NULL, 0, NULL, 1788545859199, 0, 0, 'auto_25_percent', 'neutral', NULL, 0);
...
-- Dumping data for table audit_logs (7 rows)
...
-- Dumping data for table system_backups (7 rows)
